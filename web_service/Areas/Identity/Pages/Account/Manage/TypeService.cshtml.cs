...
namespace web_service.Areas.Identity.Pages.Account.Manage
{
    ...
    public class TypeServiceModel : PageModel
    {
        ...
        // —писок всех услуг дл€ таблицы
        public IList<TypeServiceEntity> ServicesList { get; set; }

        // ћодель дл€ формы (добавление/редактирование)
        [BindProperty]
        ...
        // AJAX GET: детали дл€ редактировани€
        ...
        // ¬спомогательный метод: заполн€ет ServicesList
